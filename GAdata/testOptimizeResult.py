...
for count1 in range(numCV):
    ...
    #rf=XGBClassifier(n_estimators=50,max_depth=8)
    #rf=VotingClassifier((('rf',RandomForestClassifier(n_estimators=50,max_depth=6)),('mlp',MLPClassifier(hidden_layer_sizes=(nHidden,),learning_rate_init=learningRate)),('xgb',XGBClassifier(n_estimators=250,max_depth=6))))
